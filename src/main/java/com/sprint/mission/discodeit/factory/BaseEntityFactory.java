...
public class BaseEntityFactory implements EntityFactory {
    ...
    @Override
    public User createUser(String userName, String userEmail, String userPassword, UserRole userRole) {
    ...
    @Override
    public Channel createChannel(String channelName, User owner, String channelType, Map<UUID, User> userList) {
    ...
    @Override
    public Message createMessage(UUID messageId, String title, String content, User sender, User receiver) {
