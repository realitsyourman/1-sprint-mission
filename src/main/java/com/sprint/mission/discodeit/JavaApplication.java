...
//
//        System.out.println("\n(code review) 채널 변경");
//        channelFileService.updateChannel(codeReviewChannel.getId(), "play game with me", userLee);
//        System.out.println(channelFileService.getAllChannels());
//
//        System.out.println("\nuserHan 추가 및 조회");
//        User userHan = userFileService.createUser("Han", "han@gmail.com", "passwordhan");
//        channelFileService.addUserChannel(codeReviewChannel.getId(), userHan);
//        System.out.println(channelFileService.findChannelById(codeReviewChannel.getId()));
//
//        System.out.println("\n \"play game with me\" 채널 삭제 및 전체 조회");
//        channelFileService.removeChannelById(codeReviewChannel.getId());
//        System.out.println(channelFileService.getAllChannels());
//
//        System.out.println("\n 채널 유저 초대");
//        channelFileService.addUserChannel(talkingChannel.getId(), userHan);
//        channelFileService.addUserChannel(talkingChannel.getId(), userJung);
//        channelFileService.addUserChannel(talkingChannel.getId(), userPark);
//        System.out.println(channelFileService.findChannelById(talkingChannel.getId()));
//
//        System.out.println("\n 채널 유저 강퇴");
//        channelFileService.kickUserChannel(talkingChannel.getId(), userHan);
//        System.out.println(channelFileService.findChannelById(talkingChannel.getId()));
//
//        System.out.println("\n 채널 방장 강퇴");
//        channelFileService.kickUserChannel(talkingChannel.getId(), userLee);
//        System.out.println(channelFileService.findChannelById(talkingChannel.getId()));
//
...
//        channelFileService.addMessageInCh(talkingChannel.getId(), message);
//        channelFileService.addMessageInCh(talkingChannel.getId(), message2);
//        System.out.println(channelFileService.findChannelById(talkingChannel.getId()).getChannelMessages());
//
//        System.out.println("\n 채널에 있는 \"안녕\" 메세지 삭제");
//        channelFileService.removeMessageInCh(talkingChannel.getId(), message);
//        System.out.println(channelFileService.findChannelById(talkingChannel.getId()).getChannelMessages());
//
//        System.out.println("\n 채널에 있는 모든 메세지 조회");
//        Message message333 = messageService.createMessage("메세지 한번 더 추가", "할게요", userJung, userPark);
//        channelFileService.addMessageInCh(talkingChannel.getId(), message333);
//        Map<UUID, Message> channelInMessageAll = channelFileService.findChannelInMessageAll(talkingChannel.getId());
...
//        System.out.println(messageService.getMessageById(message3.getId()));
//
//        System.out.println("\n모든 메세지 조회");
//        System.out.println(messageService.getAllMessages());
//
//        System.out.println("\n메세지 수정");
//        messageService.updateMessage(message3.getId(), "메세지 제목을 바꿈", "잘 바뀌지?");
//        System.out.println(messageService.getMessageById(message3.getId()));
//
//        System.out.println("\n메세지 삭제");
...
//
//        System.out.println("\n채널 id로 조회");
//        System.out.println(channelService.findChannelById(basicChannel.getId()));
//
//        System.out.println("\n채널 이름으로 조회");
...
//        channelService.updateChannel(basicChannel2.getId(), "game channel", basicUserKim);
//        System.out.println(channelService.findChannelById(basicChannel2.getId()));
//
//        System.out.println("\n game channel 채널 삭제 후 전체 조회");
//        channelService.removeChannelById(basicChannel2.getId());
//        System.out.println(channelService.getAllChannels());
//
//        System.out.println("\n채널에 \"Han\" 초대");
//        User basicUserHan = userService.createUser("han", "han@mail.com", "passwordhan");
//        channelService.addUserChannel(basicChannel.getId(), basicUserHan);
//        System.out.println(channelService.findChannelById(basicChannel.getId()));
//
//        System.out.println("\n채널에 있는 \"Lee\" 강퇴");
//        channelService.kickUserChannel(basicChannel.getId(), basicUserLee);
//        System.out.println(channelService.findChannelById(basicChannel.getId()));
//
//        System.out.println("\n채널 방장(Kim) 나가기");
//        channelService.kickUserChannel(basicChannel.getId(), basicUserKim);
//        System.out.println(channelService.findChannelById(basicChannel.getId()));
//
//        System.out.println("\n채널에 메세지 추가 및 모든 조회");
...
//        channelService.addMessageInCh(basicChannel.getId(), basicMessage);
//        channelService.addMessageInCh(basicChannel.getId(), basicMessage2);
//        System.out.println(channelService.findChannelInMessageAll(basicChannel.getId()));
//
//        System.out.println("\n채널에 있는 \"안녕\" 메세지 삭제");
//        channelService.removeMessageInCh(basicChannel.getId(), basicMessage);
//        System.out.println(channelService.findChannelInMessageAll(basicChannel.getId()));
//
//        System.out.println("\n채널에 있는 모든 메세지 조회");
//        Message basicMessage3 = messageService.createMessage("추가된 메세지", "하이하이.", basicUserHan, basicUserKim);
//        channelService.addMessageInCh(basicChannel.getId(), basicMessage3);
//        System.out.println(channelService.findChannelInMessageAll(basicChannel.getId()));
//
//
//
...
//        System.out.println(messageService.getMessageById(basicMessage4.getId()));
//
//        System.out.println("\n모든 메세지 조회");
//        System.out.println(messageService.getAllMessages());
//
//        System.out.println("\n메세지 수정");
//        messageService.updateMessage(basicMessage4.getId(), "메세지 제목을 바꿈", "잘 바뀌지?");
//        System.out.println(messageService.getMessageById(basicMessage4.getId()));
//
//        System.out.println("\n메세지 삭제");
//        messageService.deleteMessage(basicMessage4.getId());
//        System.out.println(messageService.getAllMessages());
//
//
//
...
////
////        System.out.println("\n채널 방장(userOh) 강퇴");
////        channelService.kickUserChannel(channel2.getId(), userOh);
////        channelService.getAllChannels().entrySet().forEach(System.out::println);
////
////        System.out.println("\n일반 유저 강퇴");
////        channelService.kickUserChannel(channel1.getId(), userLee);
////        channelService.getAllChannels().entrySet().forEach(System.out::println);
////
////        System.out.println("\n(code review) 채널 변경");
////        channelService.updateChannel(channel1.getId(), "kakao Talk", userLee);
////        channelService.getAllChannels().entrySet().forEach(System.out::println);
////
////
////        System.out.println("\nuserHan 추가 및 전체 조회");
////        User userHan = userService.createUser("Han", "hankook@tire.com", "papapwdwdwd");
////        channelService.addUserChannel(channel1.getId(), userHan);
////        channelService.getAllChannels().entrySet().forEach(System.out::println);
////
////        System.out.println("\n채널 삭제 및 조회");
////        channelService.removeChannelById(channel2.getId());
////        channelService.getAllChannels().entrySet().forEach(System.out::println);
////
////        System.out.println();
////
...
////        System.out.println(messageService.getMessageById(message1.getId()));
////
////        System.out.println("\n메세지 여러건 조회");
////        messageService.getAllMessages().entrySet().forEach(System.out::println);
////
////        System.out.println("\n메세지 수정");
////        messageService.updateMessage(message1.getId(), "메세지 제목을 바꿈", "잘 바뀌지?");
////        messageService.getAllMessages().entrySet().forEach(System.out::println);
////
////        System.out.println("\n메세지 삭제");
...
//
//        System.out.println("\n채널 업데이트");
//        channelService.updateChannel(channel1.getId(), "바뀐채널", userHan);
//        channelService.getAllChannels().entrySet().forEach(System.out::println);
//
//
//
