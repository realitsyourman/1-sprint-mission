...
public class MessageReadStatusController {
    ...
    public ChannelReadStatus createChannelMessageReadStatus(@PathVariable("channelId") String channelId) {
        return readStatusService.createChannelReadStatus(channelId);
    }

    @RequestMapping(value = "/{channelId}", method = RequestMethod.PUT)
    public ChannelReadStatus updateChannelMessageReadStatus(@PathVariable("channelId") String channelId) {
        return readStatusService.updateChannelReadStatus(channelId);
    }

    @RequestMapping(value = "/{userName}", method = RequestMethod.GET)
    public Map<UUID, UserReadStatusResponse> readUserMessageStatus(@PathVariable("userName") String userName) {
