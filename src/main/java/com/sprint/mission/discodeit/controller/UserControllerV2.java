...
public class UserControllerV2 {
  ...
  @PostMapping
  public UserCreateResponse createUser(@RequestPart("request") @Validated UserCreateRequest request,
      @RequestPart(value = "file", required = false) MultipartFile file) throws IOException {

    return userService.createUserWithProfile(request, file);
  }
  ...
  public UserStatusUpdateResponse updateUserStatus(@PathVariable("userId") UUID userId) {
    return userStateService.updateByUserId(userId);
  }
}
