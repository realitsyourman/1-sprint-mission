...
function qm() {
  ...
  function se(S, D, oe) {
    ...
    if (S && S.defaultProps) {
      for (le in pe = S.defaultProps, pe) {
        de[le] === void 0 && (de[le] = pe[le]);
      }
    }
    return {
      $$typeof: r, type: S, key: ce, ref: ve, props: de, _owner: T.current
    }
  }
  ...
  function at(S, D, oe, le, de) {
    ...
    if (ve) {
      return ve = S, de = de(ve), S = le === "" ? "." + Je(ve, 0) : le, K(de)
          ? (oe = "", S != null && (oe = S.replace(gt, "$&/") + "/"), at(de, D,
              oe, "", function (Be) {
                return Be
  ...
  var Se = {current: null}, Q = {transition: null}, ee = {
    ReactCurrentDispatcher: Se, ReactCurrentBatchConfig: Q, ReactCurrentOwner: T
  };
  ...
  return fe.Children = {
    ...
    if (D != null) {
      ...
      && (de = "" + D.key), S.type && S.type.defaultProps) {
        var pe = S.type.defaultProps;
      }
      for (ge in D) {
        $.call(D, ge) && !H.hasOwnProperty(ge) && (le[ge] = D[ge] === void 0
        && pe !== void 0 ? pe[ge] : D[ge])
      }
    }
    ...
    function u(Q) {
      ...
      if (q !== ee) {
        ...
        e:for (var S = 0, D = Q.length, oe = D >>> 1; S < oe;) {
          ...
          if (0 > c(de, q)) {
            ce < D && 0 > c(ve, de) ? (Q[S] = ve, Q[ce] = q, S = ce)
                : (Q[S] = de, Q[le] = q, S = le);
    ...
    function W(Q) {
      for (var ee = s(x); ee !== null;) {
        if (ee.callback === null) {
          ...
          u(x), ee.sortIndex = ee.expirationTime, i(v, ee);
        } else {
          break;
        }
        ee = s(x)
...
` + l[f].replace(" at new ", " at ");
  ...
  function Gn(e, t, n, o) {
    if (e = e.options, t) {
      ...
      for (n = 0; n < e.length; n++) {
        l = t.hasOwnProperty("$" + e[n].value), e[n].selected !== l
        && (e[n].selected = l), l && o && (e[n].defaultSelected = !0)
      }
    } else {
  ...
  function Br(e) {
    ...
    for (on !== null && Fr(on, e), sn !== null && Fr(sn, e), ln !== null && Fr(
        ln, e), zr.forEach(t), Mr.forEach(t), n = 0; n < un.length; n++) {
...
`).replace(im, "")
  ...
  function Sc(e) {
    ...
    function Y(k, w, C, B) {
      ...
      if (ne === null) {
        for (; re < C.length; re++) {
          ne = U(k, C[re], B), ne !== null && (w = a(ne, w, re), te === null
              ? Z = ne : te.sibling = ne, te = ne);
        }
        return Re && In(k, re), Z
      }
      for (ne = o(k, ne); re < C.length; re++) {
        Ue = b(ne, k, re, C[re], B), Ue !== null && (e && Ue.alternate !== null
        && ne.delete(Ue.key === null ? re : Ue.key), w = a(Ue, w, re), te
        === null ? Z = Ue : te.sibling = Ue, te = Ue);
      }
    ...
    function X(k, w, C, B) {
      ...
      if (ne === null) {
        for (; !ye.done; re++, ye = C.next()) {
          ye = U(k, ye.value, B), ye !== null && (w = a(ye, w, re), te === null
              ? Z = ye : te.sibling = ye, te = ye);
        }
        return Re && In(k, re), Z
      }
      for (ne = o(k, ne); !ye.done; re++, ye = C.next()) {
        ye = b(ne, k, re, ye.value, B), ye !== null && (e && ye.alternate
        !== null && ne.delete(ye.key === null ? re : ye.key), w = a(ye, w,
            re), te === null ? Z = ye : te.sibling = ye, te = ye);
      }
  ...
  function so(e, t, n, o) {
    return e = {
      tag: e, create: t, destroy: n, deps: o, next: null
  ...
  function mm(e, t, n) {
    var o = xn(e);
    if (n = {
      lane: o, action: n, hasEagerState: !1, eagerState: null, next: null
    }, qc(e)) {
      bc(t, n);
...
` + a.stack
  ...
  function lf(e, t, n) {
    ...
    if (o.mode === "hidden") {
      ...
      a !== null ? (o = a.baseLanes | n, t.memoizedState = null) : o = n, ke(gr,
          pt), pt |= o;
    }
  ...
  function af(e, t, n, o, l) {
    ...
    if (dr(t, l), t.stateNode === null) {
      mi(e, t), Kc(t, n, o), _l(t, n, o, l), o = !0;
    } else if (e === null) {
  ...
  function df(e, t, n) {
    ...
    if ((h = f) || (h = e !== null && e.memoizedState === null ? !1 : (l & 2)
      ...
      return al(t), e = t.memoizedState, e !== null && (e = e.dehydrated, e
      !== null) ? (t.mode & 1 ? e.data === "$!" ? t.lanes = 8
              : t.lanes = 1073741824 : t.lanes = 1, null)
          : (f = o.children, e = o.fallback, a
  ...
  function km(e, t, n, o, l, a, f) {
    if (n) {
      return t.flags & 256 ? (t.flags &= -257, o = Nl(Error(s(422))), hi(e, t,
          f, o)) : t.memoizedState !== null
      ...
      switch (l) {
        case"forwards":
          for (n = t.child, l = null; n !== null;) {
            e = n.alternate, e !== null && li(e) === null
            && (l = n), n = n.sibling;
          }
    ...
    switch (t.tag) {
      ...
      case 13:
        if (o = t.memoizedState, o !== null) {
          return o.dehydrated !== null ? (ke(Pe,
              Pe.current & 1), t.flags |= 128, null) : n & t.child.childLanes
      ...
      for (A in o) {
        ...
        if (h = l != null ? l[A] : void 0, o.hasOwnProperty(A) && y !== h && (y
          ...
          if (A === "style") {
            ...
            A === "dangerouslySetInnerHTML" ? (y = y ? y.__html : void 0, h = h
                ? h.__html : void 0, y != null && h !== y && (a = a || []).push(
                A, y)) : A === "children" ? typeof y != "string" && typeof y
  ...
  function be(e) {
    ...
    if (t) {
      for (var l = e.child; l !== null;) {
        n |= l.lanes | l.childLanes, o |= l.subtreeFlags
            & 14680064, o |= l.flags & 14680064, l.return = e, l = l.sibling;
      }
    } else {
          ...
          if (o && o.rangeCount !== 0) {
            ...
            t:for (; ;) {
              for (var b;
                  ...
                  === 3 && (f += U.nodeValue.length), (b = U.firstChild)
                  !== null;) {
                z = U, U = b;
              }
              for (; ;) {
                ...
                case 1:
                  if (Y !== null) {
                    var X = Y.memoizedProps, Ne = Y.memoizedState,
                        k = t.stateNode, w = k.getSnapshotBeforeUpdate(
  ...
  function Hl(e, t, n) {
    var o = e.tag;
    if (o === 5 || o === 6) {
      e = e.stateNode, t ? n.nodeType === 8 ? n.parentNode.insertBefore(e, t)
          : n.insertBefore(e, t) : (n.nodeType === 8
          ? (t = n.parentNode, t.insertBefore(e, n)) : (t = n, t.appendChild(
            ...
            try {
              ...
              for (f = 0; f < y.length; f += 2) {
                ...
                M === "style" ? ia(l, U) : M === "dangerouslySetInnerHTML" ? ra(
                    l, U) : M === "children" ? Ir(l, U) : W(l, M, U, A)
              }
              switch (h) {
                case"input":
                  ms(l, a);
    ...
    for (var o = (e.mode & 1) !== 0; G !== null;) {
      ...
      if (l.tag === 22 && o) {
        ...
        if (!f) {
          ...
          if (gi = f, (Ge = y) && !A) {
            for (G = l; G !== null;) {
              f = G, y = f.child, f.tag === 22 && f.memoizedState !== null ? jf(
                  l) : y !== null ? (y.return = f, G = y) : jf(l);
            }
          }
          for (; a !== null;) {
  ...
  function it(e, t) {
    ...
    if (o === 0) {
      ...
      if (n != null && ya(n), t === 1) {
        e.tag === 0 ? fm(_f.bind(null, e)) : hc(_f.bind(null, e)), lm(
            function () {
              !(me & 6) && hn()
            }), n = null;
      } else {
  ...
  return st.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Hm, st.createPortal = function (e,
    ...
    if (t === void 0) {
      throw typeof e.render == "function" ? Error(s(188)) : (e = Object.keys(
          e).join(","), Error(s(268, e)));
    }
  ...
  switch (rg(r, i)) {
    ...
    case 4200:
      if (!nn(r, /flex-|baseline/)) {
        return Ae + "grid-column-align" + Sr(r, i) + r;
      }
      break;
    case 2592:
    case 3360:
...
function Hn(r, i, s, u) {
  ...
  if (Wn(r)) {
    if (!Wn(d = r) || d.prototype && d.prototype.isReactComponent || !i) {
      return [r];
    }
    var c = r(i);
    return Hn(c, i, s, u)
...
function ny(r, i, s) {
  ...
  function F(K, $) {
    return function (T, H, se) {
      var Ve = T.attrs, At = T.componentStyle, qt = T.defaultProps,
          ...
          Q = Sg(H, yt, qt) || Cr, ee = function (de, ce, ve) {
            for (var pe, ge = Ke(Ke({}, ce), {className: void 0, theme: ve}),
              ...
              for (var Rt in bt) {
                ge[Rt] = Rt === "className" ? Un(ge[Rt], bt[Rt]) : Rt === "style"
                    ? Ke(Ke({}, ge[Rt]), bt[Rt]) : bt[Rt]
              }
            }
      ...
      for (var D in ee) {
        ee[D] === void 0 || D[0] === "$" || D === "as" || D === "theme"
        && ee.theme === Q || (D === "forwardedAs" ? S.as = ee.forwardedAs : Se
            && !Se(D, q) || (S[D] = ee[D]));
      }
...
function fs(r, i, s) {
  ...
  function E(I, R, L) {
    ...
    if (I && !L && typeof I == "object") {
      if (_.endsWith(R, "{}")) {
        R = u ? R : R.slice(0, -2), I = JSON.stringify(I);
...
const Co = {
  ...
  transformRequest: [function (i, s) {
    ...
    if (_.isURLSearchParams(i)) {
      return s.setContentType("application/x-www-form-urlencoded;charset=utf-8",
          !1), i.toString();
    }
    let m;
    if (d) {
  ...
  transformResponse: [function (i) {
    ...
    if (i && _.isString(i) && (u && !this.responseType || c)) {
      ...
      try {
        ...
        if (p) {
          throw m.name === "SyntaxError" ? ie.from(m, ie.ERR_BAD_RESPONSE, this,
              null, this.response) : m
        }
      }
    }
    return i
...
ps.transitional = function (i, s, u) {
  ...
  return (d, p, m) => {
    if (i === !1) {
      throw new ie(c(p, " has been removed" + (s ? " in " + s : "")),
          ie.ERR_DEPRECATED);
    }
...
function $0(r, i, s) {
  ...
  for (; c-- > 0;) {
    ...
    if (p) {
      ...
      if (v !== !0) {
        throw new ie("option " + d + " must be " + v, ie.ERR_BAD_OPTION_VALUE);
      }
      continue
    }
    if (s !== !0) {
...
function Md({channel: r, isActive: i, onClick: s, hasUnread: u}) {
  ...
  if (m.length > 2) {
    ...
    return g.jsxs(yd, {
      $isActive: i, onClick: s, children: [g.jsx(uy, {
  ...
  return g.jsxs(yd, {
    $isActive: i, onClick: s, children: [g.jsxs(ly, {
      children: [g.jsx("img",
  ...
  channels: [], pollingInterval: null, fetchChannels: async s => {
    ...
    try {
      const u = await he.post(`${Xe.apiBaseUrl}/channels/public`, s), c = {
        ...u.data, participantIds: [], lastMessageAt: u.data.createdAt
      };
    ...
    try {
      const u = await he.post(`${Xe.apiBaseUrl}/channels/private`,
          {participantIds: s}), c = {
        ...u.data, participantIds: s, lastMessageAt: u.data.createdAt
      };
      return r(d => ({channels: [...d.channels, c]})), c
    } catch (u) {
...
function Iv({isOpen: r, type: i, onClose: s, onCreateSuccess: u}) {
  ...
  return r ? g.jsx(fv, {
    onClick: s, children: g.jsxs(dv, {
      onClick: $ => $.stopPropagation(), children: [g.jsxs(pv, {
        children: [g.jsx(hv,
        ...
        children: g.jsxs(gv, {
          ...
          children: [E && g.jsx(jv, {children: E}),
            i === "PUBLIC" ? g.jsxs(g.Fragment, {
              ...
              type: "submit", children: i === "PUBLIC" ? "채널 만들기" : "대화 시작하기"
            })]
        })
      })]
    })
  ...
  attachments: {}, fetchAttachment: async s => {
    ...
    try {
      const u = await he.get(`${Xe.apiBaseUrl}/binaryContents/${s}`), {
        bytes: c, contentType: d, fileName: p, size: m
      } = u.data, x = {
        url: `data:${d};base64,${c}`, contentType: d, originalName: p, size: m
      };
...
function m1({channel: r}) {
  const i = vo(P => P.messages), s = vo(P => P.fetchMessages),
      ...
      d = Wt(P => P.profileImages), p = Dt(P => P.users), {
        attachments: m, fetchAttachment: v
      } = p1();
  ue.useEffect(() => {
    if (r != null && r.id) {
        ...
        try {
          ...
          try {
            const K = await (await window.showSaveFilePicker({
              suggestedName: I, types: [{
                description: "Files", accept: {
...
function g1({channel: r}) {
  const [i, s] = ue.useState(""), [u, c] = ue.useState([]),
      ...
      m = async O => {
        if (O.preventDefault(), !(!i.trim() && u.length === 0)) {
          try {
            await d({
              content: i.trim(), channelId: r.id, authorId: p, attachments: u
            }), s(""), c([])
          } catch (P) {
  ...
  return ue.useEffect(() => () => {
    ...
    children: [u.length > 0 && g.jsx(a1, {children: u.map((O, P) => j(O, P))}),
      g.jsxs(e1, {
        onSubmit: m, children: [g.jsxs(n1, {
          as: "label", children: ["+", g.jsx("input", {
            type: "file", multiple: !0, onChange: v, style: {display: "none"}
          })]
        }), g.jsx(t1, {
          value: i,
        ...
        onSubmit: L, children: [g.jsxs(Fi, {
          ...
          children: [g.jsx(Bi, {children: "프로필 이미지"}), g.jsxs(I1, {
            children: [g.jsx(_1, {src: E || Qt, alt: "profile"}), g.jsx(N1, {
              type: "file", accept: "image/*", onChange: R, id: "profile-image"
...
function z1() {
  const r = ut(v => v.currentUserId), i = Dt(v => v.users), {
        fetchUsers: s, updateUserStatus: u
