...
//
//        Channel updatedChannel = channelService.updateChannel(channel.getId(), newChannelName, user);
//
...
//        Channel channel = channelService.createChannel(channelName, ownerUser, userList);
//        channelService.addUserChannel(channel.getId(), user);
//
//        Channel updatedChannel = channelService.findChannelById(channel.getId());
...
//        Channel channel = channelService.createChannel(channelName, ownerUser, userList);
//        channelService.addUserChannel(channel.getId(), user);
//        channelService.kickUserChannel(channel.getId(), user);
//
//        Channel updatedChannel = channelService.findChannelById(channel.getId());
