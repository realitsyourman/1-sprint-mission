...
class JCFMessageServiceTest {
    ...
    void getMessageByIdTest() {
        ...
        Message foundMessage = messageService.getMessageById(createdMessage.getMessageId());
    ...
    void updateMessageTest() {
        ...
        Message updatedMessage = messageService.updateMessage(message.getMessageId(), newTitle, newContent);
    ...
    void updateMessageWithNullTitleTest() {
        ...
        assertThrows(NullMessageContentException.class, () ->
                messageService.updateMessage(message.getMessageId(), null, "New Content")
        );
    }
